/**
 * LEGACY folder details UI — kept for easy A/B comparison.
 * Active page: `FolderPage.tsx`. Swap the import in `DocsRouteResolver.tsx` to restore this.
...
interface LegacyFolderPageProps {
...
export function LegacyFolderPage({ folderPath }: LegacyFolderPageProps) {
