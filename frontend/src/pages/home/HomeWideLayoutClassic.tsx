...
interface HomeWideLayoutClassicProps {
  hostLabel: string;
  tagline: string;
...
/** Previous wide home. Restore by importing this as HomeWideLayout from HomePage. */
export function HomeWideLayoutClassic({
  hostLabel,
  tagline,
  involvementPreset,
  documentCount,
