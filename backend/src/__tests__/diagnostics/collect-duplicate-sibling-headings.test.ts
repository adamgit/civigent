 ...
 */
function skeletonFrom(rows: Row[]): { allStructuralEntries: () => Array<{ heading: string; headingLevel: number; sectionFile: string; headingPath: string[]; absolutePath: string; isSubSkeleton: boolean }> } {
  return {
...
describe("collectDuplicateSiblingHeadingDetails", () => {
  it("returns nothing for a well-formed layout (no sibling shares a heading)", () => {
    const skeleton = skeletonFrom([
      { heading: "Overview", headingLevel: 2, sectionFile: "overview.md", headingPath: ["Overview"] },
      { heading: "Timeline", headingLevel: 2, sectionFile: "timeline.md", headingPath: ["Timeline"] },
    ]);
    expect(collectDuplicateSiblingHeadingDetails(skeleton)).toEqual([]);
  });

  it("reports two top-level siblings with the same heading text and headingLevel", () => {
    const skeleton = skeletonFrom([
      { heading: "Overview", headingLevel: 2, sectionFile: "o1.md", headingPath: ["Overview"] },
      { heading: "Overview", headingLevel: 2, sectionFile: "o2.md", headingPath: ["Overview"] },
    ]);
    ...
    expect(details[0]).toContain("heading level 2");
  ...
  it("catches a duplicate heading buried inside a nested sub-skeleton — the flat-map masking case", () => {
    ...
    const skeleton = skeletonFrom([
      { heading: "Timeline", headingLevel: 2, sectionFile: "timeline.md", headingPath: ["Timeline"], isSubSkeleton: true },
      { heading: "Milestone", headingLevel: 3, sectionFile: "m1.md", headingPath: ["Timeline", "Milestone"] },
      { heading: "Milestone", headingLevel: 3, sectionFile: "m2.md", headingPath: ["Timeline", "Milestone"] },
    ]);
    const details = collectDuplicateSiblingHeadingDetails(skeleton);
    expect(details.length).toBe(1);
  ...
  it("distinguishes duplicate document-level BFH roots from duplicate named siblings", () => {
    const skeleton = skeletonFrom([
      { heading: "", headingLevel: 0, sectionFile: "--before-first-heading--a.md", headingPath: [] },
      { heading: "", headingLevel: 0, sectionFile: "--before-first-heading--b.md", headingPath: [] },
    ]);
    const details = collectDuplicateSiblingHeadingDetails(skeleton);
    expect(details.length).toBe(1);
  ...
  it("distinguishes a duplicate NESTED body-holder from a duplicate named sibling", () => {
    ...
    const skeleton = skeletonFrom([
      { heading: "Overview", headingLevel: 2, sectionFile: "overview.md", headingPath: ["Overview"], isSubSkeleton: true },
      { heading: "", headingLevel: 0, sectionFile: "bh1.md", headingPath: ["Overview"] },
      { heading: "", headingLevel: 0, sectionFile: "bh2.md", headingPath: ["Overview"] },
    ]);
    const details = collectDuplicateSiblingHeadingDetails(skeleton);
    expect(details.length).toBe(1);
  ...
  it("reports each collision group separately when multiple sibling-lists collide", () => {
    const skeleton = skeletonFrom([
      { heading: "Overview", headingLevel: 2, sectionFile: "o1.md", headingPath: ["Overview"] },
      { heading: "Overview", headingLevel: 2, sectionFile: "o2.md", headingPath: ["Overview"] },
      { heading: "Timeline", headingLevel: 2, sectionFile: "t.md", headingPath: ["Timeline"], isSubSkeleton: true },
      { heading: "Milestone", headingLevel: 3, sectionFile: "m1.md", headingPath: ["Timeline", "Milestone"] },
      { heading: "Milestone", headingLevel: 3, sectionFile: "m2.md", headingPath: ["Timeline", "Milestone"] },
    ]);
    const details = collectDuplicateSiblingHeadingDetails(skeleton);
  ...
  it("does NOT flag a same-heading sibling at DIFFERENT levels as a duplicate (they occupy different sibling slots)", () => {
    ...
    const skeleton = skeletonFrom([
      { heading: "Timeline", headingLevel: 2, sectionFile: "t.md", headingPath: ["Timeline"], isSubSkeleton: true },
      { heading: "Milestone", headingLevel: 3, sectionFile: "a.md", headingPath: ["Timeline", "Milestone"] },
      { heading: "Milestone", headingLevel: 4, sectionFile: "b.md", headingPath: ["Timeline", "Milestone"] },
    ]);
    expect(collectDuplicateSiblingHeadingDetails(skeleton)).toEqual([]);
  });
});
